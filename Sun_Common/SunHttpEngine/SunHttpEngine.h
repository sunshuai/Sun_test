...
@interface SunHttpEngine : NSObject <ASIHTTPRequestDelegate>
{
    NSTimeInterval _m_timeInterval_timeout; // 请求超时秒数
    int _m_int_numberOfTimesToRetryOnTimeout; // 请求超时重新请求次数
...
/**
 ...
 @return YKHttpEngine: http请求引擎,该类作为所有请求的容器。
 */
+(SunHttpEngine*)engineWithHeaderParams:(NSDictionary *)headerParams;
