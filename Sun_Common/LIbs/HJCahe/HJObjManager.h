...
/*
 Internal state. These are the HJMOHandlers that are currently wait for turn to loading.
 */
@property (nonatomic, retain) NSMutableArray* waitingHandlers;
@property (nonatomic, assign) int maxWaitCount;
